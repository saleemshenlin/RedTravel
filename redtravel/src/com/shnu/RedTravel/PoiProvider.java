...
public class PoiProvider extends ContentProvider {
	 ...
	 */
	static final String AUTHORITY = "com.shnu.RedTravel.poiprovider";
	/**
	 * 定义一个Uri
	 */
	 ...
	 * 定义一个单个查询的MIME类型
	 */
	static final String SINGLE_RECORD_MIME_TYPE = "vnd.android.cursor.item/vnd.com.shnu.RedTravel.status";
	/**
	 * 定义一个多个查询的MIME类型
	 */
	static final String MULTIPLE_RECORDS_MIME_TYPE = "vnd.android.cursor.dir/vnd.com.shnu.RedTravel.mstatus";
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		SQLiteDatabase db = mPoiDB.getDbHelper().getWritableDatabase();
		try {
			if (id < 0) {
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		long id = this.getId(uri); //
		SQLiteDatabase db = mPoiDB.getDbHelper().getReadableDatabase(); //
		try {
			if (id < 0) {
